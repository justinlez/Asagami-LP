      ...
      <div className="flex flex-col w-[90vw] mx-auto gap-y-[3vh] md:gap-y-0">
          ...
          <div className="flex flex-col md:flex-row w-5/6 mx-auto my-11 justify-between gap-14">
            ...
            <div className="flex flex-col items-center md:w-[33%] hover:scale-[1.1] transition- duration-200">
              ...
              <p className="text-center">
                ...
                <strong className="italic">full potential</strong> through
                responsible integration of AI, making knowledge accessible,
        ...
        <div className="flex flex-col md:flex-row w-full my-[7%]">
          ...
          <div className="flex flex-col md:w-1/3 gap-[1vh] px-[3vw] py-3 items-center text-center">
            ...
            <p className="w-[90%]">
              Bridge the gap between learning and execution, helping people apply
              knowledge confidently in the real world.
            </p>
          </div>
        </div>
        <div className="flex flex-col w-full items-center my-[5vh]">
          <h2 className="flex font-notoserif text-[#0052b4] text-center">
            What We Value in Everyday Decision-Making
          </h2>
